...
/*   Updated: 2023/09/01 20:24:20 by aajaanan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	tilde(char **path_and_home_dir, t_queue_char *q,
			t_env_var *env_var_list, int *i);
void	handle_dollar_sign_cd(char **vars, t_env_var *env_var_list, int *i,
			t_queue_char *q);
void	handle_double_quotes_2_cd(char *path, t_env_var *env_var_list,
			t_queue_char *q, int *i);
void	handle_double_quotes_cd(char **vars, t_env_var *env_var_list,
			t_queue_char *q, int *i);
// ******* cd_helpers.c ******** //
...
void	get_new_path(char *path, int *exit_status, t_env_var *env_var_list,
			t_queue_char *q);
// ******* cd.c ******** //
